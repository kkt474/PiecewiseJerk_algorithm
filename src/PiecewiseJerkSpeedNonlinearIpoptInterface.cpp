    ...
    IndexStyleEnum &index_style)
{
    ...
    // 单调  // s monotone constraints s_i+1 - s_i >= 0.0
    ...
    // each constraint's nonzeros number
    nnz_jac_g = 0;
    // s_i+1 - s_i
    ...
    Ipopt::IpoptCalculatedQuantities *ip_cq)
{
    ...
    if (use_soft_safety_bound_)
    {
        ...
        LOG(INFO) << "lower soft s boundary average intrustion is ["
                  ...
                  << "].";
        LOG(INFO) << "upper soft s boundary average intrustion is ["
